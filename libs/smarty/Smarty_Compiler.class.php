...
class Smarty_Compiler extends Smarty {
    ...
    function _compile_file($resource_name, $source_content, &$compiled_content)
    {
        ...
        $rlHook -> load('smartyCompileFileBottom', $compiled_content, $source_content, $resource_name);

        // static data class parser
        if (!defined('REALM') || (defined('REALM') && REALM != 'admin')) {
            $rlStatic->collectJSStaticCode($resource_name, $compiled_content);
        }
