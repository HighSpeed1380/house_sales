...
//SkipDebug
		if (0 < func_num_args()) {
			$objLanguageManager =& (new xajaxLanguageManager())->getInstance();
			trigger_error(
...
//EndSkipDebug
		...
		$objResponseManager =& (new xajaxResponseManager())->getInstance();
...
//EndSkipDebug
	...
	*/
	function _sendHeaders()
	{
		$objArgumentManager =& (new xajaxArgumentManager())->getInstance();
