...
//EndSkipAIO
		...
		$this->objPluginManager =& (new xajaxPluginManager())->getInstance();
		$this->objPluginManager->loadPlugins($aPluginFolders);

		$this->objLanguageManager =& (new xajaxLanguageManager())->getInstance();
		$this->objArgumentManager =& (new xajaxArgumentManager())->getInstance();
		$this->objResponseManager =& (new xajaxResponseManager())->getInstance();
