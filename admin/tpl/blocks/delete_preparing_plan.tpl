...
<div style="margin: 5px 10px">
    ...
    <div style="margin: 5px 0;">
        ...
        <div id="bottom_buttons" class="hide">
            ...
            {if $config.trash}
                {assign var='notice_phrase' value=$lang.notice_drop_plan|replace:$replace:$account_details.Username}
            {else}
                {assign var='notice_phrase' value=$lang.notice_delete_plan|replace:$replace:$account_details.Username}
            {/if}
